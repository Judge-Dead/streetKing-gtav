...
function LoadUser(identifier, source, new)
	...
	print(colors.red .."Load User : "..result[1].permission_level, result[1].money, result[1].identifier, result[1].group, colors.reset)
...
function registerUser(identifier, source)
	if not hasAccount(identifier) then
		...
		MySQL:executeQuery("INSERT INTO users (`identifier`, `group`, `permission_level`, `money`, `bankbalance`, `personalvehicle`, `job`, `isFirstConnection`, `enService`) VALUES ('@username', 'user', '0', '@money', '0', '', '1', '1', '0')",
